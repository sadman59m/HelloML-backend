...
class DatasetPreprocessor():
    ...
    def standarize_numerical_feature_scaling(self, df_values, col_indexs):
        """method of apply feature scaling for numerical values using standarization technique"""
        from sklearn.preprocessing import StandardScaler
        sc = StandardScaler()
        # apply for numrical columns
